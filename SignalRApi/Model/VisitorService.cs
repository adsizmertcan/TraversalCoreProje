...
namespace SignalRApi.Model
{
    public class VisitorService
    {
        ...
        public async Task SaveVisitor(Visitor visitor)
        {
            ...
            await _hubContext.Clients.All.SendAsync("CallVisitorList", "abc");
        }
        public List<VisitorChart> GetVisitorChartList() 
        {
            ...
            {
                command.CommandText = "Select * from crosstab (	'Select VisitDate,City,CityVisitCount From visitors	Order By 1,2') " +
